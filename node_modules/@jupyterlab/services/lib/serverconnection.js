...
(function (Private) {
    ...
    function makeSettings(options = {}) {
        ...
        if (options.baseUrl && !options.wsUrl) {
            ...
            if (baseUrl.indexOf('http') !== 0) {
                if (typeof location !== 'undefined') {
                    baseUrl = coreutils_1.URLExt.join(location.origin, baseUrl);
                }
                else {
                    ...
                    baseUrl = coreutils_1.URLExt.join('http://localhost:8888/', baseUrl);
                }
            }
            extra = {
        ...
        return Object.assign({}, ServerConnection.defaultSettings, options, extra);
    }
